...
export default class Audi extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, x, y, spriteKey, facingUp = true) {
    ...
    if (x <= 495) {
      ...
      facingUp = false;
      this.flipY = !this.flipY; // allows us to flip the audi sprite by toggling (faces audi toward player)
    }
